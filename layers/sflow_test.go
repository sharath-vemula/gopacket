...
// Test packet collected from PCAP from SolarWinds tool. See the test below for contents
var SFlowTestPacketWithIPv4Data = []byte{
	,
...
// Discarded packet event
var SFlowTestDiscardedPacket = []byte{
	0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x01, 0x0a, 0x14, 0x04, 0x00, 0x00, 0x00, 0x00, 0x64,
	0x00, 0x01, 0x78, 0xe0, 0x73, 0x03, 0x48, 0x78, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x05,
	0x00, 0x00, 0x00, 0x9c, 0x00, 0x01, 0x78, 0xe0, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01,
	...
	,
...
func TestDecodeSFlowExpandedFlowSampleWithIPV4Data(t *testing.T) {
	p := gopacket.NewPacket(SFlowTestPacketWithIPv4Data, LayerTypeEthernet, gopacket.Default)
	if p.ErrorLayer() != nil {
		t.Error("Failed to decode packet:", p.ErrorLayer().Error())
	}
	...
	if got, ok := p.ApplicationLayer().(*SFlowDatagram); ok {
		want := &SFlowDatagram{
			...
			SubAgentID:      uint32(0),
			SequenceNumber:  uint32(20384278),
			AgentUptime:     uint32(1731087263),
				...
				SFlowFlowSample{
					...
					Records: []SFlowRecord{
						SFlowIpv4Record{
							...
							Length: 3000,
							Protocol:    6,
							IPSrc: net.IP{0x0a, 0xef, 0x08, 0xa5},
							IPDst: net.IP{0x0a, 0xef, 0x08, 0xb7},
							PortSrc: 51455,
							PortDst: 15203,
							TCPFlags: 0,
							TOS: 0,
				...
				SFlowFlowSample{
					...
					Records: []SFlowRecord{
						SFlowIpv4Record{
							...
							Length: 3000,
							Protocol:    6,
							IPSrc: net.IP{0x0a, 0xef, 0x08, 0xa6},
							IPDst: net.IP{0x0a, 0xef, 0x08, 0xb6},
							PortSrc: 51455,
							PortDst: 15155,
							TCPFlags: 0,
							TOS: 0,
...
func TestDecodeDiscardedPacketEvent(t *testing.T) {
	p := gopacket.NewPacket(SFlowTestDiscardedPacket, LayerTypeSFlow, gopacket.Default)
	...
	want := &SFlowDatagram{
		...
		DiscardedPacketEvents: []SFlowDiscardedPacketEvent{
			SFlowDiscardedPacketEvent{
				EnterpriseID:    0x0,
				Format:          SFlowTypeDiscardedPacketEvent,
				SampleLength:    0x9c,
				SequenceNumber:  0x0178e0,
				SourceIDClass:   0x2,
				SourceIDIndex:   0x1,
				...
				Records: []SFlowRecord{
					...
					SFlowExtendedEgressQueueRecord{
						SFlowBaseFlowRecord: SFlowBaseFlowRecord{
							EnterpriseID:   0x0,
							Format:         0x40c,
							FlowDataLength: 0x4,
